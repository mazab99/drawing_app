              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    height: 35,
                    width: 35,
                    child: const Icon(Icons.undo,color: Colors.red, size: 22),
                  ),
                ),
                GestureDetector(
                  onTap: () async {
                  ...
                  child: Container(
                    ...
                    height: 35,
                    width: 35,
                    child: const Icon(Icons.save,color: Colors.red, size: 22),
                  ),
                ),
                GestureDetector(
                  onTap: () {
                  ...
                  child: Container(
                    ...
                    height: 35,
                    width: 35,
                    child: const Icon(Icons.redo, color: Colors.red,size: 22),
                  ),
                ),
              ],
            )
                                        ...
                                        ...backgroundColors!.map((color) {
                                          return GestureDetector(
                                            ...
                                            child: AnimatedContainer(
                                              ...
                                              margin: const EdgeInsets.all(4),
                                              height: selectedBackgroundColor ==
                                                      color
                                                  ? 30
                                                  : 25,
                                              width: selectedBackgroundColor ==
                                                      color
                                                  ? 30
                                                  : 25,
                                            ),
